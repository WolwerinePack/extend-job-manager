...
<?php //You can start editing here. ?>
					...
					<div class="def-panel">
						<div class="panel-title">
							...
							<h2><?php comments_number(esc_html('0 Commentaire', THEME_NAME), esc_html('1 Commentaire', THEME_NAME), esc_html('% Commentaires', THEME_NAME)); ?></h2>
						</div>
							...
							<?php else : ?>
								...
								<div class="comment-form">
									...
									<div id="writecomment">
										...
										<?php 
											$defaults = array(
												'comment_field'       	=> '<p class="contact-form-message"><label for="comment">'.esc_html("Commentaire:",THEME_NAME).'<span class="required">*</span></label><textarea name="comment" id="comment" placeholder="'.esc_html("Votre commentaire..",THEME_NAME).'"></textarea></p>',
												...
												'title_reply_to'       => '',
												'cancel_reply_link'    	=> '',
												'label_submit'         	=> ''.esc_html( 'Poster un Commentaire', THEME_NAME ).'',
											);
