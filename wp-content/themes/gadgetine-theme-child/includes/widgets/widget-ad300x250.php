...
class tz_ad300_widget extends WP_Widget {
	...
	function TZ_Ad300_Widget() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'tz_ad300_widget', 'description' => esc_html('A widget that allows the display and configuration of of a single 300x250 Banner.', 'framework') );

		/* Widget control settings */
		$control_ops = array( 'width' => 300, 'height' => 250, 'id_base' => 'tz_ad300_widget' );

		/* Create the widget */
		$this->__construct( 'tz_ad300_widget', esc_html(THEME_FULL_NAME.' Custom 300x250 Ad', 'framework'), $widget_ops, $control_ops );
	}
