            ...
            <div class="panel-content article-list-big">
                ...
                <div class="item item-the-huge<?php if($image['show']==false) { ?> no-image<?php } ?>">
                    ...
                    <div class="item-content">
                        ...
                        ?>
                        <a href="<?php the_permalink();?>" class="read-more-link"><?php esc_html_e("Lire",THEME_NAME);?><i class="fa fa-chevron-right"></i></a>
                    </div>
                <!-- END .item -->
                </div>
            ...
            <?php if ($my_query->have_posts()) : while ($my_query->have_posts()) : $my_query->the_post(); ?>
                ...
                <div class="item">
                    <div class="item-content">
                        ...
                        <?php 
                            if(($columnID=="column6" && ot_check_sidebar(OT_page_ID()) == "off") || ($columnID == "column12"))  {
