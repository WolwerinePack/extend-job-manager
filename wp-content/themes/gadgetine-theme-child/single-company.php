 ...
 */
    ...
    if ( is_plugin_active('wp-job-manager/wp-job-manager.php') && class_exists( 'Astoundify_Job_Manager_Companies' )) 
    {
        ...
        $company_why_temp = get_post_meta( $post_ID,'_company_why');
        $company_why=$company_why_temp[0];
        ...
        $company_number = get_post_meta( $post_ID, '_company_number', true);
        $company_profil = get_post_meta( $post_ID, '_company_profil', true);
                                        ...
                                        <div class="page-header-meta">
                                            ...
                                            <ul >
                                                <?php if ($company_tagline ) : ?>
                                                    ...
                                                    <li class="tagline">
                                                        <div><pre class="company-single pure-u-24-24"><?php echo $company_tagline; ?></pre></div>
                                                    </li>
                                                <?php endif; ?>
                                                <?php if ( $company_why ) { ?>
                                                <h1 class="titre-meta">Pourquoi travailler pour nous ?</h1>
                                                    <li class="why">
                                                        <div><pre class="company-single pure-u-24-24"><?php echo $company_why; ?></pre></div>
                                                    </li>
                                                <?php } ?>
                                                <?php if ( $company_number ) { ?>
                                                <h1 class="titre-meta">Nombres de postes a pourvoir cette année et dans quelle région</h1>
                                                    <li class="number">
                                                        <div><pre class="company-single pure-u-24-24"><?php echo $company_number; ?></pre></div>
                                                    </li>
                                                <?php } ?>
                                                <?php if ( $company_profil ) { ?>
                                                <h1 class="titre-meta">Type de profil que nous recherchons</h1>
                                                    <li class="profil">
                                                        <div><pre class="company-single pure-u-24-24"><?php echo $company_profil; ?></pre></div>
                                                    </li>
                                                <?php } ?>
                                                <?php
                                                    //global $post;
