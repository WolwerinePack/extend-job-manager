                ...
                ?>
                    <div class="item">
                        <a href="<?php the_permalink();?>">
                            <?php echo ot_image_html($my_query->post->ID,583,389,"item-photo"); ?>
                        </a>
                        ...
                        <div class="rating-table">
                            ...
                            ?>
                                ...
                                <div class="rate-item">
                                    <div class="right ot-star-rating"><span style="width:<?php echo $ratingPrecentage;?>%"><strong class="rating"><?php echo floor(($ratingPrecentage/5) * 2) / 2;?></strong> <?php esc_html_e("out of 5", THEME_NAME);?></span></div>
                        ...
                        <p><?php echo get_post_meta ( $post->ID, "_".THEME_NAME."_conclusion", true );?>
                            <a href="<?php the_permalink();?>"><?php esc_html_e("Read More ...", THEME_NAME);?></a>
                        </p>
                    </div>
            <?php endwhile; ?>
            <?php endif; ?>
